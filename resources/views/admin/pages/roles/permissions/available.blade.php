...
@section('title', "Permissões disponíveis para função {$role->name } ")
...
@section('content_header')
    ...
    <h1>Permissões disponíveis para função {{ $role->name }} 
    </h1>    
@stop
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-condensed">
                ...
                <tbody>
                    <form action=" {{ route('roles.permissions.attach', $role->id) }}" method="POST" class="form">
                        @csrf
